...
- **Universal "brain" interface — every controllable entity (player, NPC, enemy, boss, RL agent) shares one input shape** `[V4/D5]` - Continuation of the controllable-entity unification arc that already merged enemies + bosses behind `ActorControlFrame`. The full design:
