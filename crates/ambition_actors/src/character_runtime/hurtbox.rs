...
pub fn hurtbox_world_aabb(
    ...
    body_center: ambition_engine_core::Vec2,
    facing: f32,
) -> ambition_engine_core::CenteredAabb {
    ...
    ambition_engine_core::CenteredAabb::from_center_size(
        center,
        ambition_engine_core::Vec2::new(half_extents.0 * 2.0, half_extents.1 * 2.0),
    )
}
...
impl ResolvedHurtboxes {
    ...
    pub fn world_volumes(
        ...
        body_center: ambition_engine_core::Vec2,
        facing: f32,
    ) -> Option<Vec<ambition_engine_core::CenteredAabb>> {
