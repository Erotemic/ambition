...
pub(super) struct HudCameraParams<'w, 's> {
    ...
    player: bevy::prelude::Query<
        ...
        (
            ...
            &'static ambition_gameplay_core::player::BodyGroundState,
            &'static ambition_gameplay_core::player::BodyWallState,
            &'static ambition_gameplay_core::player::BodyDashState,
            &'static ambition_gameplay_core::player::BodyJumpState,
            &'static ambition_gameplay_core::player::BodyMana,
            &'static ambition_gameplay_core::player::BodyModeState,
            &'static ambition_gameplay_core::player::BodyLedgeState,
            &'static ambition_gameplay_core::player::BodyFlightState,
            &'static ambition_gameplay_core::player::BodyBlinkState,
            &'static ambition_gameplay_core::player::BodyComboTrace,
    ...
    ecs_actors: bevy::prelude::Query<
        ...
        (
            ...
            &'static ambition_gameplay_core::features::BodyCombat,
        ),
