...
pub fn init_sandbox_resources(app: &mut App) {
    ...
    let asset_config = app
        .world()
        .get_resource::<ambition_sandbox::assets::game_assets::GameAssetConfig>()
        .cloned()
        .unwrap_or_default();
    let sandbox_catalog = ambition_sandbox::assets::sandbox_assets::build_sandbox_catalog_with(
        &asset_config,
        &sandbox_data.audio,
        |manifest| {
    ...
    app.insert_resource(ldtk_world::SandboxLdtkProject(ldtk_project.clone()))
        ...
        // first Update tick.
        .insert_resource(ambition_sandbox::inventory::PlayerInventory::starter())
        ...
        .insert_resource(ambition_sandbox::persistence::settings::UserSettings::default());
}
