...
impl Plugin for SandboxSimulationResourcesPlugin {
    fn build(&self, app: &mut App) {
        app.add_message::<SfxMessage>()
            ...
            // `ambition_gameplay_core::time_control` for the policy + dispatch and ADR
            ...
            // attached. See `ambition_gameplay_core::profiling` for the helper API and
            // `docs/recipes/profiling.md` for Tracy / per-system profiling.
            .insert_resource(ambition_gameplay_core::dev::profiling::StartupProfiler::default())
            .insert_resource(ambition_gameplay_core::trace::GameplayTraceBuffer::default())
            .insert_resource(ambition_gameplay_core::dialog::DialogState::default())
            .insert_resource(ambition_gameplay_core::MovingPlatformSet::default())
            ...
            .insert_resource(ambition_gameplay_core::encounter::EncounterState::default())
            .insert_resource(ambition_gameplay_core::encounter::EncounterRegistry::default())
            .insert_resource(ambition_gameplay_core::encounter::SwitchActivationQueue::default())
            .insert_resource(ambition_gameplay_core::encounter::EncounterSwitchIndex::default())
            .insert_resource(ambition_gameplay_core::encounter::EncounterMusicRequest::default())
            ...
            .insert_resource(ambition_gameplay_core::persistence::save::SandboxSave::default())
            ...
            // hookup.
            .insert_resource(ambition_gameplay_core::rooms::GatePortalRegistry::default())
            // The intro/cut-rope story hooks (IntroPlugin) and the boss
            // encounter registry are registered by
            // `ambition_content::AmbitionContentPlugin` (Stage 11 /
            // Task J).
            .insert_resource(ambition_gameplay_core::menu::map::MapMenuState::default())
