...
//!
//! This is a thin shim around `ambition_app::app::run_visible`. All the
//! gameplay systems, helpers, and App-builder logic moved to the library
//! crate (`crates/ambition_gameplay_core/src/app.rs`) in Slice 5 of ADR 0012's
...
//! from `ambition_gameplay_core::lib`, which calls `app::run_web` after the
