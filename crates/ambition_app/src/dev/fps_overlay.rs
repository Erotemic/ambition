...
//! (persisted across sessions via `ambition_actors::persistence::settings::persistence`), or
...
use ambition_actors::persistence::settings::UserSettings;
...
/// `FpsOverlayState`, and `ambition_actors::persistence::settings::persistence` autosaves the
...
mod tests {
    ...
    fn default_video_settings_show_fps_is_true() {
        let settings = ambition_actors::persistence::settings::UserSettings::default();
        assert!(
