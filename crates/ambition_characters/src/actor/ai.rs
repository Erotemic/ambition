...
//!
//! The seldom_state component vocabulary in `ambition_platformer2d_actor_monolith::state_machines`
...
/// An actor's in-place respawn countdown, run only under `RespawnPolicy::InPlace`.
