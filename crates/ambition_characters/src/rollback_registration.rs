...
where
    R: RollbackRegistrar,
{
    registrar.rollback_component_canonical::<crate::actor::BodyHealth>(
        OWNER,
        "body.health",
    );
    registrar.rollback_component_canonical::<crate::actor::pose::ActorPose>(
        OWNER,
        "actor.pose",
    );
    registrar.rollback_component_canonical::<crate::actor::WornCharacter>(
        OWNER,
        "actor.worn_character",
    );
    registrar.rollback_component_clone::<crate::equipment::WornEquipment>(
        OWNER,
        "actor.worn_equipment",
    );
    registrar.rollback_component_canonical::<crate::actor::body::BodyCombat>(
        OWNER,
        "actor.body_combat",
    );
    ...
    registrar.rollback_component_canonical::<crate::actor::character_catalog::AuthoredBrainContext>(
            OWNER,
            "actor.authored_brain_context",
        );
    registrar.rollback_component_canonical::<crate::brain::ActorControl>(
        OWNER,
        "actor.control",
    );
    ...
    registrar.rollback_component_canonical::<crate::actor::BodyWallet>(
        OWNER,
        "body.wallet",
    );
    registrar.rollback_component_clone::<crate::brain::ScriptedControl>(
        OWNER,
    ...
    registrar.rollback_component_clone::<crate::actor::BodyAnimFacts>(
        OWNER,
        "actor.animation_facts",
    );
    registrar.rollback_component_clone::<crate::actor::ActorFaction>(
        OWNER,
        "actor.faction",
    );
    ...
    registrar.rollback_component_clone::<crate::brain::PlayerSlot>(
        OWNER,
        "actor.player_slot",
    );
    registrar.rollback_component_clone::<crate::brain::ActionSet>(
        OWNER,
        "actor.action_set",
    );
    ...
    registrar.rollback_component_clone::<crate::brain::BossCapability>(
        OWNER,
        "boss.capability",
    );
    registrar.rollback_component_clone::<crate::brain::MovesetRanged>(
        OWNER,
    ...
    registrar.declare_rollback_derived_component::<crate::actor::attack_gesture::ResolvedAttackGesture>(
        OWNER,
