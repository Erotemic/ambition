...
use ambition_sandbox::dialog::yarn_bindings::{YarnStateMirror, YarnStateMirrorData};
...
/// [`YarnContentBindings`](ambition_sandbox::dialog::yarn_bindings::YarnContentBindings)
