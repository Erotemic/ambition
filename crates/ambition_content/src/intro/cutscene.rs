...
//!
//! Inserted into the shared [`ambition_sandbox::presentation::cutscene::CutsceneLibrary`] and
//! [`ambition_sandbox::presentation::cutscene::RoomCutsceneBindings`] by
...
use ambition_sandbox::presentation::cutscene::CutsceneLibrary;

/// Room → cutscene bindings for the intro slice. Mirrors the shape of
/// [`ambition_sandbox::presentation::cutscene::RoomCutsceneBindings::defaults`] — `(room_id,
...
fn intro_wake_script() -> ambition_sandbox::presentation::cutscene::script::CutsceneScript {
    ambition_sandbox::presentation::cutscene::script::CutsceneScript::new(
        "intro_wake",
        vec![
            ambition_sandbox::presentation::cutscene::script::CutsceneBeat::Fade {
                to_alpha: 0.0,
                seconds: 0.8,
            },
            ambition_sandbox::presentation::cutscene::script::CutsceneBeat::Banner {
                text: "// boot".into(),
                seconds: 1.0,
            },
            ambition_sandbox::presentation::cutscene::script::CutsceneBeat::Dialogue {
                speaker: "Creator".into(),
                text: "Hey you, you're finally awake.".into(),
            },
            ambition_sandbox::presentation::cutscene::script::CutsceneBeat::SetFlag {
...
fn intro_raid_script() -> ambition_sandbox::presentation::cutscene::script::CutsceneScript {
    ambition_sandbox::presentation::cutscene::script::CutsceneScript::new(
        "intro_raid",
        vec![
            ambition_sandbox::presentation::cutscene::script::CutsceneBeat::Banner {
...
fn drain_market_arrival_script() -> ambition_sandbox::presentation::cutscene::script::CutsceneScript
{
    ambition_sandbox::presentation::cutscene::script::CutsceneScript::new(
...
fn first_ripple_script() -> ambition_sandbox::presentation::cutscene::script::CutsceneScript {
    ...
    ambition_sandbox::presentation::cutscene::script::CutsceneScript::new(
        ...
        vec![
            ...
            ambition_sandbox::presentation::cutscene::script::CutsceneBeat::Wait { seconds: 0.4 },
            ambition_sandbox::presentation::cutscene::script::CutsceneBeat::Dialogue {
                speaker: "Gate Janitor".into(),
...
) -> ambition_sandbox::presentation::cutscene::script::CutsceneScript {
