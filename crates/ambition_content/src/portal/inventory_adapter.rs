...
//!
//! Portal core owns the [`PortalGun`](ambition_sandbox::portal::PortalGun) component and the
//! [`PortalGunPickup`](ambition_sandbox::portal::PortalGunPickup) body, but the *policy* of
...
//! Ambition item state. The reusable portal core never imports `ambition_sandbox::items`,
...
/// [`ambition_sandbox::items::pickup`] (their bodies are pure item-equip
/// machinery, the twins of `equip_held_spec` / `unequip_held`); the
/// content adapter keeps the roster-policy systems below.
pub use ambition_sandbox::items::pickup::{equip_portal_gun, unequip_portal_gun};
...
pub fn drop_portal_gun_system(
    ...
    mut players: Query<
        ...
        (
            ...
            With<PrimaryPlayer>,
            With<PortalGun>,
            Without<ambition_sandbox::features::HeldItem>,
        ),
    >,
    mut sfx: MessageWriter<ambition_sandbox::audio::SfxMessage>,
) {
    ...
    sfx.write(ambition_sandbox::audio::SfxMessage::Play {
...
pub fn pickup_portal_gun_system(
    ...
    holding_item: Query<
        ...
        (
            With<PlayerEntity>,
            With<PrimaryPlayer>,
            With<ambition_sandbox::features::HeldItem>,
        ),
    >,
...
mod tests {
    use super::*;
    use ambition_sandbox::portal::arm_portal_pickups;
    ...
    fn picking_up_the_portal_gun_activates_it() {
        let mut app = App::new();
        app.add_message::<ambition_sandbox::audio::SfxMessage>();
