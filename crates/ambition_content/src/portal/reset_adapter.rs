...
//!
//! Portal core's [`clear_portals_on_reset`](ambition_sandbox::portal::clear_portals_on_reset)
//! consumes the portal-owned [`ClearPortals`](ambition_sandbox::portal::ClearPortals) signal,
...
use ambition_sandbox::portal::ClearPortals;
