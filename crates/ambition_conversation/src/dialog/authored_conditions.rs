...
//! named anything else.
//!
//! ⇒ this refuses, with a reason. Prepared references from authored source are
//! D127 M2's job, and a refusal is a thing M2 can replace; a wrong answer is a
//! thing M2 would have to find first.
...
fn prepare_argument(
    ...
    // author whether they typo'd an id or forgot a plugin. Re-writing that
    // message here would be a second, worse copy of it.
