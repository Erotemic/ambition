...
where
    R: RollbackRegistrar,
{
    registrar.require_rollback::<crate::EncounterLifecycle>(
        OWNER,
    ...
    registrar.rollback_component_clone::<crate::EncounterObjective>(
        OWNER,
        "encounter.objective",
    );
    registrar.rollback_component_clone::<crate::EncounterCameraZoom>(
        OWNER,
        "encounter.camera_zoom",
    );
    registrar.rollback_component_clone::<crate::EncounterLockWall>(
        OWNER,
        "encounter.lock_wall",
    );
    registrar.rollback_component_clone::<crate::EncounterTrack>(OWNER, "encounter.track");
    registrar.rollback_component_canonical::<crate::EncounterLifecycle>(
        OWNER,
        "encounter.lifecycle",
    );
    ...
    registrar.rollback_map_entities::<crate::EncounterParticipants>(
        OWNER,
    ...
    registrar.clear_message_on_rollback::<crate::EncounterCommand>(
        OWNER,
        "message.encounter_command",
    );
    registrar.clear_message_on_rollback::<crate::EncounterEventMsg>(
        OWNER,
        "message.encounter_event",
    );
    registrar.clear_message_on_rollback::<crate::EncounterGate>(
        OWNER,
