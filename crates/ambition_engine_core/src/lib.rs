...
pub use movement::{
    ...
    ActionEdges, ActionKey, DepthOcclusions, Edge, FlightTuning, FrameEvents,
    GroundContactTransition, InputState,
    LedgeFacts, LedgeMomentumTuning, MovementAction,
    MomentumParams, MotionModel, MotionModelKind, MotionModelSpec, MotionStepContext,
    MotionStepResult, MovementOp, MovementTuning, NormalSpineCtx, OcclusionSpan, RouteDeparture,
