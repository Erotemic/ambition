...
pub use movement::{
    ...
    AdhesiveCrawlerMotion, AxisLocomotion, AxisManeuverState, AxisSweptMotion, AxisSweptParams,
    BlinkEvent, BodyMotionFacts, ComboMark, CrawlAttachment, CrawlerParams, CrawlerState,
    FlightTuning, FrameEvents, InputState, LedgeFacts, LedgeMomentumTuning, MomentumParams,
    MotionModel, MotionModelKind, MotionModelSpec, MotionStepContext, MotionStepResult, MovementOp,
    MovementTuning, NormalSpineCtx, RouteDeparture, SurfaceMomentumMotion, SurfaceMotion,
    SurfaceRef, TraversalAbilityTuning, AIR_ACCEL, AIR_FRICTION, AIR_JUMPS, BLINK_COOLDOWN,
    BLINK_DISTANCE, BLINK_HOLD_THRESHOLD, COYOTE_TIME, DASH_BUFFER, DASH_COOLDOWN, DASH_SPEED,
