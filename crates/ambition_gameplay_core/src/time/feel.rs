...
impl Default for SandboxFeelTuning {
    fn default() -> Self {
        Self {
            ...
            enemy_attack_windup: crate::combat::events::DEFAULT_ENEMY_ATTACK_WINDUP,
            enemy_attack_active: crate::combat::events::DEFAULT_ENEMY_ATTACK_ACTIVE,
            boss_attack_windup: crate::combat::events::DEFAULT_BOSS_ATTACK_WINDUP,
            boss_attack_active: crate::combat::events::DEFAULT_BOSS_ATTACK_ACTIVE,
