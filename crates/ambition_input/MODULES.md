...
|---|---|
| [`actions`](src/actions.rs) | The `Platformer2dInputActionMonolith` leafwing action enum. |
...
| [`seating`](src/seating.rs) | Where a session's local seats come from, and who decides. |
