...
pub struct FeatureLifecycleBundle {
    ...
    pub room_scoped: ambition_platformer2d_shared_tangle::lifecycle::RoomScopedEntity,
    pub id: FeatureId,
...
impl FeatureLifecycleBundle {
    pub fn new(id: impl Into<String>, name: impl Into<String>, aabb: CenteredAabb) -> Self {
        Self {
            ...
            room_scoped: ambition_platformer2d_shared_tangle::lifecycle::RoomScopedEntity,
...
pub struct FeatureRenderedBundle {
    ...
    pub room_visual: ambition_platformer2d_shared_tangle::lifecycle::RoomVisual,
}
...
impl FeatureRenderedBundle {
    pub fn new(id: impl Into<String>, name: impl Into<String>, aabb: CenteredAabb) -> Self {
        Self {
            ...
            room_visual: ambition_platformer2d_shared_tangle::lifecycle::RoomVisual,
        }
    }
}
