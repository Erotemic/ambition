...
use ambition_characters::actor::definition::{BodySource, CharacterDefinition, Lineage, Vitals};
...
// workspace is unchanged. See `ambition_characters::binding_namespaces`.
