...
pub mod chests;
mod damage;
pub mod dismounted_rider;
pub mod fighter_ladder;
...
pub use ambition_boss_encounter::ecs::{
    ...
    project_boss_attack_state_from_move, sync_boss_encounter_phase,
...
pub use hazards::{advance_hazards, apply_hazard_contacts, HazardTickSet};
