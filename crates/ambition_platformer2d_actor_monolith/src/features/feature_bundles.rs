...
//! base with actors (`FeatureRenderedBundle`, owned by the spawn capability because an
...
use ambition_platformer2d_actor_spawn::actor_bundles::FeatureRenderedBundle;
...
impl PickupBundle {
    pub fn new(
        ...
        Self {
            base: FeatureRenderedBundle::new(id, name, aabb),
