...
//! `ambition_platformer2d_shared_tangle` crate. This module re-exports
...
//! `ambition_platformer2d_shared_tangle::body` / `ambition_platformer2d_core::cast`.
//!
...
//! - `orientation` -> `crate::physics`, `crate::avatar`, `crate::features`, `ambition_time::WorldTime`
//!
