...
pub use movement::{
    ...
    ParryTiming, PhasedGravityJumpTuning, PhasedJumpState, ResetCause, RouteDeparture,
    ShieldTuning, SurfaceMomentumMotion, SurfaceMotion, SurfaceRef, TraversalAbilityTuning,
