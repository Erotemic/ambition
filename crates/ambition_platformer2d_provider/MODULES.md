...
**ambition_platformer2d_provider** — The platformer experience-provider layer.
...
| [`composition`](src/composition.rs) | **Hosting an experience: the seven steps, minus the six that are not decisions.** |
