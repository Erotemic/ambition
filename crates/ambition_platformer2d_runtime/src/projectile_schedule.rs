...
//! `ambition_platformer2d_runtime` should schedule against these runtime names rather than
//! reaching through `ambition_platformer2d_actor_monolith::{projectile, enemy_projectile}`; this keeps
//! the residual glue enumerable while the remaining actor-side projectile
//! steppers are split.

pub use ambition_platformer2d_actor_monolith::projectile::{charge_projectile_input, step_projectiles};
