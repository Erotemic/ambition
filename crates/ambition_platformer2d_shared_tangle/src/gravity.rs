...
impl GravityField {
    ...
    pub fn motion_frame(&self, magnitude: f32) -> ambition_platformer2d_core::MotionFrame {
        ambition_platformer2d_core::MotionFrame::from_direction(self.dir, magnitude)
    }
...
mod tests {
    ...
    fn collect_gravity_zones_snapshots_the_components() {
        ...
        app.world_mut().spawn(GravityZone {
            aabb: ambition_platformer2d_core::Aabb::new(Vec2::new(0.0, 0.0), Vec2::new(10.0, 10.0)),
            dir: Vec2::new(0.0, -1.0),
        });
        app.update();
    ...
    fn oscillating_zone_slides_horizontally_over_time() {
        ...
        let e = app
            ...
            .spawn((
                GravityZone {
                    aabb: ambition_platformer2d_core::Aabb::new(base, Vec2::new(20.0, 20.0)),
                    dir: Vec2::new(0.0, -1.0),
                },
                OscillatingZone {
                    base_center: base,
