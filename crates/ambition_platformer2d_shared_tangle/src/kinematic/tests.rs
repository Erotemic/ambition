...
fn aabb_bodies_never_collide_with_surface_chains() {
    ...
    world.chains.push(ambition_platformer2d_core::SurfaceChain::open(
        "chain floor",
...
fn conf_frame(dir: Vec2) -> ambition_platformer2d_core::AccelerationFrame {
    ambition_platformer2d_core::AccelerationFrame::new(dir)
}
