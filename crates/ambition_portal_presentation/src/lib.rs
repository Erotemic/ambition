...
pub use view_cones::{
    ...
    handle_portal_view_cone_dump_hotkey, sync_portal_view_cones, PortalApertureLosQuality,
    PortalConeMesh, PortalDebugOverlay, PortalViewConeConfig, PortalViewConeDebugDumpRequest,
