...
///
/// ⚠ still `ambition_runtime`, deliberately, and it is not a lie: this module IS
/// in `ambition_runtime`, because the dependency direction says it must be until
...
pub(in crate::rollback) fn register(app: &mut App) {
    ...
    app.require_rollback::<ambition_projectiles::LiveProjectile>(OWNER, "entity:live_projectile")
        ...
        // `ambition_platformer_primitives::projectile::ProjectileGameplay`, which
