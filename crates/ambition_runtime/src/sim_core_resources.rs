...
impl Plugin for SimCoreResourcesPlugin {
    fn build(&self, app: &mut App) {
        app.add_message::<SfxMessage>()
            ...
            .add_message::<ambition_gameplay_core::features::GameplaySfxRequested>()
            ...
            .init_resource::<ambition_gameplay_core::time::time_control::RegimePolicy>()
            .init_resource::<ambition_gameplay_core::time::time_control::RequestedClockScale>()
            .init_resource::<ambition_time::ClockState>()
            .register_type::<ambition_gameplay_core::game_mode::GameMode>()
            // Startup wall-clock profiler (the PostStartup report is the
            // app's; the resource is engine so phase_mark works anywhere).
            .init_resource::<ambition_gameplay_core::dev::profiling::StartupProfiler>()
            .init_resource::<ambition_gameplay_core::trace::GameplayTraceBuffer>()
            .init_resource::<ambition_gameplay_core::dialog::DialogState>()
            .init_resource::<ambition_gameplay_core::MovingPlatformSet>()
            .init_resource::<ambition_gameplay_core::SandboxSimState>()
            .init_resource::<ambition_gameplay_core::SandboxDevState>()
            .init_resource::<ambition_gameplay_core::features::GameplayBanner>()
            .init_resource::<ambition_gameplay_core::features::FeatureEcsWorldOverlay>()
            ...
            .init_resource::<ambition_gameplay_core::encounter::EncounterState>()
            .init_resource::<ambition_gameplay_core::encounter::EncounterRegistry>()
            .init_resource::<ambition_gameplay_core::encounter::SwitchActivationQueue>()
            .init_resource::<ambition_gameplay_core::encounter::EncounterSwitchIndex>()
            .init_resource::<ambition_gameplay_core::encounter::EncounterMusicRequest>()
            // Boss music routes through its own resource so the regular
            // encounter tick can't clobber the boss's MusicRequested events.
            .init_resource::<ambition_gameplay_core::encounter::BossEncounterMusicRequest>()
            .init_resource::<ambition_gameplay_core::rooms::RoomMusicRequest>()
            ...
            .init_resource::<ambition_gameplay_core::rooms::GatePortalRegistry>()
            .init_resource::<ambition_gameplay_core::menu::map::MapMenuState>()
            .init_resource::<ambition_gameplay_core::CameraEaseState>()
            .init_resource::<ambition_gameplay_core::CameraEaseTuning>()
            .init_resource::<ambition_gameplay_core::time::camera_ease::CameraShakeState>()
            .init_resource::<ambition_gameplay_core::session::reset::SandboxResetRequested>()
            ...
            .init_resource::<ambition_gameplay_core::time::feel::SandboxFeelTuning>()
            .init_resource::<ambition_gameplay_core::world::physics::PhysicsSandboxSettings>()
            // Dev-editable tuning mirrors (read by the dev-edit sync in the
            // player frame). Ownership moves to the dev-tools carve (E1d).
            .init_resource::<ambition_gameplay_core::dev::dev_tools::DeveloperTools>()
            .init_resource::<ambition_gameplay_core::dev::dev_tools::EditablePlayerStats>()
            .init_resource::<ambition_gameplay_core::dev::dev_tools::EditableMovementTuning>()
