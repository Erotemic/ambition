...
impl Plugin for SimCoreResourcesPlugin {
    fn build(&self, app: &mut App) {
        app.add_message::<SfxMessage>()
            ...
            .add_message::<ambition_actors::features::SetFlagRequested>()
            .add_message::<ambition_actors::features::QuestAdvanceRequested>()
            .add_message::<ambition_actors::features::SwitchActivated>()
            .add_message::<ambition_actors::features::GameplaySfxRequested>()
            .add_message::<ambition_actors::features::HitEvent>()
            .add_message::<ambition_actors::features::ActorStimulus>()
            .add_message::<ambition_actors::features::ResetRoomFeaturesEvent>()
            .add_message::<ambition_actors::features::GameplayBannerRequested>()
            ...
            .init_resource::<ambition_actors::features::GameplayBanner>()
