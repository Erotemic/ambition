...
//!
//! Portal core's [`publish_portal_carves`](crate::portal::publish_portal_carves)
//! writes the aperture geometry into the portal-owned
//! [`PortalCarves`](crate::portal::PortalCarves) resource. Portal core never
