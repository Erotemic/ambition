...
//!
//! Portal core owns the [`PortalGun`](crate::portal::PortalGun) component and the
//! [`PortalGunPickup`](crate::portal::PortalGunPickup) body, but the *policy* of
...
//! Ambition item state. The reusable portal core never imports `crate::items`,
...
mod tests {
    use super::*;
    use crate::portal::arm_portal_pickups;
