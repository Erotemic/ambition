...
impl Plugin for SandboxSimulationResourcesPlugin {
    fn build(&self, app: &mut App) {
        app.add_message::<SfxMessage>()
            ...
            .add_message::<crate::features::SetFlagRequested>()
            .add_message::<crate::features::QuestAdvanceRequested>()
            .add_message::<crate::features::SwitchActivated>()
            .add_message::<crate::features::GameplaySfxRequested>()
            ...
            .add_message::<crate::ambition_content::bosses::CutRopeRoomReplayRequested>()
            ...
            .insert_resource(crate::ambition_content::bosses::CutRopeBossArenaState::default())
            .insert_resource(crate::ambition_content::bosses::CutRopeHeavyObjectCycle::default())
            .insert_resource(crate::ambition_content::bosses::PendingCutRopeRoomReplay::default())
