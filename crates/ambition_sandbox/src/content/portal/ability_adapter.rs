...
//!   aperture edges. Touches `crate::player::PlayerAbilities`, so it is Ambition
//!   glue, not crate core.
...
use crate::portal::pieces::portal_map_vec;
use crate::portal::{PlayerMovementIntent, PortalEmission, PortalInputWarp, PortalTransit};
