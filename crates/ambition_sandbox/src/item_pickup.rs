...
const DEBUG_GROUND_ITEMS: &[DebugGroundItem] = &[
    ...
    DebugGroundItem { spec: || crate::brain::held_item_by_id(crate::volley::VOLLEY_ID), offset: Vec2::new(-360.0, 0.0), half: 18.0, name: "Ground item: volley gauntlet" },
    ...
    DebugGroundItem { spec: || crate::brain::held_item_by_id(crate::meteor::METEOR_ID), offset: Vec2::new(-560.0, 0.0), half: 18.0, name: "Ground item: meteor gauntlet" },
];
