...
// Character `*_SHEET` statics were deleted in Stage 20 / B3: catalog
// characters resolve sheets DATA-driven via `sheet_for_character_id`
// (manifest record + `sprite_tuning` from character_catalog.ron).
