...
pub struct RoomSpec {
    ...
    // NOTE: interactables, pickups, and chests migrated to the single
    // `placements` channel (fable audit F9.2); they lower via
    // `PlacementSchema::{Interactable, Pickup, Chest}`.
