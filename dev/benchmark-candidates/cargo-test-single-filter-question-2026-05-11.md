...
You are preparing validation commands for a Rust workspace after splitting two modules, `inventory` and `pause_menu`, inside the package `ambition_platformer2d_actor_monolith`.
