...
- `crates/ambition_sandbox/src/body_mode.rs`
- `crates/ambition_sandbox/src/mobile_input.rs`
...
ambition_sandbox --lib ...`, not on subjective architecture preferences.
...
```rust
// crates/ambition_sandbox/src/body_mode/tests.rs
use super::*;
