...
- `crates/ambition_platformer2d_actor_monolith/src/body_mode.rs`
- `crates/ambition_platformer2d_actor_monolith/src/mobile_input.rs`
- `crates/ambition_platformer2d_actor_monolith/src/map_menu.rs`
...
ambition_platformer2d_actor_monolith --lib ...`, not on subjective architecture preferences.
...
```rust
// crates/ambition_platformer2d_actor_monolith/src/map_menu/ui.rs
use super::*;
...
```rust
// crates/ambition_platformer2d_actor_monolith/src/body_mode/tests.rs
use super::*;
