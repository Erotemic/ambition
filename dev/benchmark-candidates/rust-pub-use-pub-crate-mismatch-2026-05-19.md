...
You are splitting `crates/ambition_platformer2d_actor_monolith/src/features/ecs/mod.rs`
...
Compile this with `cargo check -p ambition_platformer2d_actor_monolith --lib`. What does
