...
```text
crates/ambition_platformer2d_actor_monolith/src/trace.rs
```
...
```text
crates/ambition_platformer2d_actor_monolith/src/trace.rs
crates/ambition_platformer2d_actor_monolith/src/trace/model.rs
crates/ambition_platformer2d_actor_monolith/src/trace/buffer.rs
crates/ambition_platformer2d_actor_monolith/src/trace/detect.rs
crates/ambition_platformer2d_actor_monolith/src/trace/dump.rs
crates/ambition_platformer2d_actor_monolith/src/trace/systems.rs
crates/ambition_platformer2d_actor_monolith/src/trace/tests.rs
```
...
```text
crates/ambition_platformer2d_actor_monolith/src/audio.rs
```

into:

```text
crates/ambition_platformer2d_actor_monolith/src/audio.rs          # facade
crates/ambition_platformer2d_actor_monolith/src/audio/render.rs   # waveform/music rendering helpers
crates/ambition_platformer2d_actor_monolith/src/audio/runtime.rs  # runtime handles, Kira channels, radio state
crates/ambition_platformer2d_actor_monolith/src/audio/tests.rs
```
...
```text
crates/ambition_platformer2d_actor_monolith/src/audio.rs
crates/ambition_platformer2d_actor_monolith/src/audio/runtime.rs
crates/ambition_platformer2d_actor_monolith/src/audio/render.rs
crates/ambition_platformer2d_actor_monolith/src/audio/tests.rs
```
...
`../assets` resolved to `crates/ambition_platformer2d_actor_monolith/assets`.
