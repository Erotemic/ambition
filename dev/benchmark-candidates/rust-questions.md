...
```text
crates/ambition_actors/src/trace.rs
```
...
```text
crates/ambition_actors/src/trace.rs
crates/ambition_actors/src/trace/model.rs
crates/ambition_actors/src/trace/buffer.rs
crates/ambition_actors/src/trace/detect.rs
crates/ambition_actors/src/trace/dump.rs
crates/ambition_actors/src/trace/systems.rs
crates/ambition_actors/src/trace/tests.rs
```
...
```text
crates/ambition_actors/src/audio.rs
```

into:

```text
crates/ambition_actors/src/audio.rs          # facade
crates/ambition_actors/src/audio/render.rs   # waveform/music rendering helpers
crates/ambition_actors/src/audio/runtime.rs  # runtime handles, Kira channels, radio state
...
```text
crates/ambition_actors/src/audio.rs
crates/ambition_actors/src/audio/runtime.rs
crates/ambition_actors/src/audio/render.rs
crates/ambition_actors/src/audio/tests.rs
```
...
`../assets` resolved to `crates/ambition_actors/assets`.
