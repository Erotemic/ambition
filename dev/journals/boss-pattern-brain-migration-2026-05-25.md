...
* `crates/ambition_platformer2d_actor_monolith/src/brain/boss_pattern.rs` (NEW, 681 lines):
...
* `crates/ambition_platformer2d_actor_monolith/src/brain/mod.rs`: re-exports
  `boss_pattern::*` (BossPatternCfg/State/Context/AttackState +
  vocabulary + tick fn).

* `crates/ambition_platformer2d_actor_monolith/src/brain/state_machine.rs`: placeholder
...
* `crates/ambition_platformer2d_actor_monolith/src/features/ecs/spawn.rs`:
