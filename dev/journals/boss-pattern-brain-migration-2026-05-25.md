...
* `crates/ambition_sandbox/src/brain/boss_pattern.rs` (NEW, 681 lines):
...
* `crates/ambition_sandbox/src/brain/mod.rs`: re-exports
  `boss_pattern::*` (BossPatternCfg/State/Context/AttackState +
  vocabulary + tick fn).

* `crates/ambition_sandbox/src/brain/state_machine.rs`: placeholder
