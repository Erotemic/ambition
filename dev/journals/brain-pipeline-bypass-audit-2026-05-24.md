...
Daytime continuation #3 in `TODO-controllable-entity.md` (`docs/archive/TODO-controllable-entity.md` — removed from the checkout 2026-09-05; read it with `git show <pre-epoch-sha>:<path>`):
> *`update_player` consume `ActorControl` frame instead of `PlayerInputFrame` directly.*

### Enemy bypass — `EnemyRuntime::update`

**File:** `crates/ambition_platformer2d_actor_monolith/src/features/enemies.rs`
...
**Files:**
- `crates/ambition_platformer2d_actor_monolith/src/features/bosses.rs`
- `crates/ambition_platformer2d_actor_monolith/src/features/ecs/bosses.rs`
...
**Files:**
- `crates/ambition_platformer2d_actor_monolith/src/player/ledge_grab.rs:41,51,65`
- `crates/ambition_platformer2d_actor_monolith/src/player/swim.rs:47,70,73,97,122`
...
- `TODO-controllable-entity.md` (`docs/archive/TODO-controllable-entity.md` — removed from the checkout 2026-09-05; read it with `git show <pre-epoch-sha>:<path>`) — overall plan + chunks 1–4f checklist.
