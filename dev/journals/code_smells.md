...
## 2026-07-19 Portal gun visuals read sim `BodyKinematics` directly (read-model leak)
...
- **Suggested fix / size:** S — read the pose from `ambition_sim_view` like `hit_flash.rs`/`hud.rs` do.
