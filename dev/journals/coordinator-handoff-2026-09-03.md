...
- The 13 union failures left: 8 doctrine (a demo asserting no HUD under an all-features build), 3
  painted_blocks, 1 sanic asset binding — judgement-shaped, not mechanical.
...
Last gate run by this coordinator: 6/6 on c6b40e2c2 (6,963/6,963). Commits since are docs/scripts only except none; the next Rust gate is owed at whatever tip the next coordinator lands first.
