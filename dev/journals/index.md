...
| A closed item whose argument checks out step by step and whose conclusion is false — a shared noun naming two objects (a behaviour id vs a placement id, a branch vs a submodule pin, an absent dependency vs an optional one) | [`../benchmark-candidates/every-link-true-and-the-chain-false-2026-09-04.md`](../benchmark-candidates/every-link-true-and-the-chain-false-2026-09-04.md) |
| A mechanic is correct at every layer and still never occurs in a match — every layer's own test stays green while that is true | [`cpu-grabs-never-happened-in-a-match-2026-08-18.md`](cpu-grabs-never-happened-in-a-match-2026-08-18.md), then [`what-a-hold-is-worth-2026-08-19.md`](what-a-hold-is-worth-2026-08-19.md) for the remedy shape (a scorer TERM, gated on facts, with explicit zeros where a naive rule scores highest) |
