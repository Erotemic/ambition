...
Expose backend-neutral physics intent in `crates/ambition_engine_core/src/` only where it helps gameplay data describe physical effects without depending directly on sandbox presentation adapters.
