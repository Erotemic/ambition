...
of external review
(`../archive/reviews/gpt56-jon-conv-2026-07-29.md` (docs/archive/reviews/gpt56-jon-conv-2026-07-29.md — removed from the checkout 2026-09-05; still in git history),
`../archive/reviews/gpt56-reply-2026-07-29-v2.md` (docs/archive/reviews/gpt56-reply-2026-07-29-v2.md — removed from the checkout 2026-09-05; still in git history),
...
the archived campaign's matrix (docs/archive/planning-superseded/2026-08-13/engine/api-1.0-campaign.md — removed from the checkout 2026-09-05; still in git history) has a proof:
...
(`../planning/architecture-campaign-2026-07-28.md` (docs/archive/architecture-campaign-2026-07-28.md — removed from the checkout 2026-09-05; still in git history))
