...
Use `crates/ambition_platformer2d_core/src/player_clusters.rs`, `crates/ambition_platformer2d_actor_monolith/src/player/`, and `docs/current/state.md` for current references.
