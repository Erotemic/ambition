...
- The brain/action seam exists and the player already flows through `ActorControl`: [`crates/ambition_sandbox/src/actor_control.rs`](../../crates/ambition_sandbox/src/actor_control.rs), [`crates/ambition_sandbox/src/brain/player.rs`](../../crates/ambition_sandbox/src/brain/player.rs), and [`crates/ambition_app/src/app/player_tick.rs`](../../crates/ambition_app/src/app/player_tick.rs).
