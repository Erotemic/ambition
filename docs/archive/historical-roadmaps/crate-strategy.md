...
`ambition_engine` should own reusable mechanics and can depend on Bevy math/geometry primitives. `ambition_platformer2d_actor_monolith` and future story crates should own content, data manifests, presentation, and input mappings.
