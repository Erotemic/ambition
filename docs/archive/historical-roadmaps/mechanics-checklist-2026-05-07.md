# Archived: mechanics-checklist.md

Superseded by `docs/mechanics/expressibility-checklist.md`, which is shorter and synced to the current code shape.

Original path: `docs/recipes/mechanics-checklist.md`
