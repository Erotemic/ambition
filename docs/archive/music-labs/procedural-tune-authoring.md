...
```bash
cargo run -p ambition_platformer2d_actor_monolith --bin tune_preview -- \
    --track crates/ambition_platformer2d_actor_monolith/assets/ambition/tune_examples/example_drift.ron \
...
```text
crates/ambition_platformer2d_actor_monolith/assets/ambition/sandbox.ron
```
