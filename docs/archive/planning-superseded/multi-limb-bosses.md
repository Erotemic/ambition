...
- `integrate_sim_bodies` / `integrate_actor_body`
  (`ambition_platformer2d_actor_monolith/src/features/ecs/actors/update.rs:662`, `:522`) reads each
  body's own `control.0` and drives the shared engine seam.
- `advance_move_playback` (`ambition_platformer2d_actor_monolith/src/combat/moveset.rs:299`) spawns
