...
(`crates/ambition_platformer2d_actor_monolith/assets/ambition/sandbox.ron`) points at those
...
4. The asset manager catalog
   (`crates/ambition_platformer2d_actor_monolith/src/sandbox_assets.rs::extend_with_music_entries`)
