...
`docs/planning/` is now the ONE source of truth ([`vision.md`](../../../planning/vision.md)
is the top; [`tracks.md`](../../../planning/tracks.md) is the live queue; the review docs
...
[`docs/archive/reviews/static-audit-response-2026-07-10.md`](../static-audit-response-2026-07-10.md)
and [`tracks.md`](../../../planning/tracks.md).
...
- **P2 — decomposition + doctrines (ACTIVE; D-A/D-B/D-C DONE, encounter
  ...
  [`engine/encounter-orchestration.md`](../../../planning/engine/encounter-orchestration.md) for the
  execution ledger + the honest E7 LoC audit.
  [`engine/decomposition.md`](../../../planning/engine/decomposition.md) is executed
  ...
  ships with SSB.
- **P3 — demo wave 1: [Sanic](../../../planning/demos/sanic.md) + [Super
  Mary-O](../../../planning/demos/super-mary-o.md).** **UNBLOCKED — E5-finish landed
...
- **P4 — demo wave 2: [Super Smash
  Siblings](../../../planning/demos/super-smash-siblings.md), then [Hollow
  Lite](../../../planning/demos/hollow-lite.md).** SSB pulls CM6 + N1 + FB1–FB4; Hollow
...
| # | Decision | Where |
|---|---|---|
| M13 | **The sweep law** — path-dependent state changes evaluate swept, never sampled | [collision-and-ccd.md](../../../planning/engine/collision-and-ccd.md) §1 |
...
| M15 | **One damage axis, two death policies** (HpDepleted / Unbounded+blast) — percent and HP are the same meter | [combat-model.md](../../../planning/engine/combat-model.md) §1 |
| M16 | **Wearing is possession semantics** — the worn character's authored kit IS the kit; no fallback overlay | landed `0189338b` |
| M17 | **The no-cheat brain contract** — difficulty never reads privileged state or scales damage; skill = prediction + option quality under human-rate constraints | [fighter-brain.md](../../../planning/engine/fighter-brain.md) |
| M18 | **Fight quality is measured** — telegraph grammar + validator + playtester metrics gate boss authoring; taste passes are banked as data | [boss-design.md](../../../planning/engine/boss-design.md) |
| M19 | **Demo rules are mode-scoped plugins** — ambition hosts every demo; global-state demo rules are a design bug | [demos/README.md](../../../planning/demos/README.md) |
| M20 | **Determinism is a managed same-build contract** (fixed-tick option, input streams, desync canary); cross-platform float determinism is NOT promised | [netcode.md](../../../planning/engine/netcode.md) N0 — *flagged Q4 below for Jon's confirmation* |
| M21 | **Encounter is orchestration, never an actor type** - boss-capable actors work without encounters; encounters compose arbitrary participants/objectives and may contain no boss or no actors | [encounter-orchestration.md](../../../planning/engine/encounter-orchestration.md) - Jon Crall, 2026-07-10 |
...
- **Q4 (✅ ANSWERED 2026-07-06):** determinism = **level 2, same-build
  ...
  in [`engine/netcode.md`](../../../planning/engine/netcode.md) §Q4-RESOLVED + N0.
...
- **Q31 — the W3 vocab-arrow / authored-placement model RULED (Jon +
  ...
  world is not immutable). Canonical: [`engine/architecture.md`](../../../planning/engine/architecture.md) §4b + Tier-0 note. The [W-a..W-e] sub-questions were
...
- **Q33 — tuning is not a planning blocker (Jon).** DI/quality/slope/
  ...
  decision principle ([`decision-principles.md`](../../../planning/decision-principles.md)).
