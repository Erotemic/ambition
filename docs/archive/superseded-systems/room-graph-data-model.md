# Archived: room-graph-data-model.md

Superseded by current LDtk/data-driven ECS docs and concept pages.

Original path: `docs/systems/room-graph-data-model.md`
...
See `docs/archive/superseded-migrations/room-layout-refactor.md` for the current conventions.
