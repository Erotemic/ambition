...
Live JSON inspection (`crates/ambition_platformer2d_actor_monolith/assets/ambition/worlds/intro.ldtk`):
...
```text
crates/ambition_platformer2d_actor_monolith/src/map_menu/model.rs
...
PYTHONPATH=tools/ambition_ldtk_tools python3 -m ambition_ldtk_tools list-metadata \
  --ldtk crates/ambition_platformer2d_actor_monolith/assets/ambition/worlds/intro.ldtk
...
PYTHONPATH=tools/ambition_ldtk_tools python3 \
  ...
  --secondary-world crates/ambition_platformer2d_actor_monolith/assets/ambition/worlds/sandbox.ldtk \
  crates/ambition_platformer2d_actor_monolith/assets/ambition/worlds/intro.ldtk
...
`cargo fmt --check` / `cargo test -p ambition_platformer2d_actor_monolith --lib` / `cargo run
-p ambition_platformer2d_actor_monolith --bin headless` were not run as part of this task (no
...
- `area create --dry-run` is supported on individual area YAMLs; pass
  `--ldtk crates/ambition_platformer2d_actor_monolith/assets/ambition/worlds/intro.ldtk` so the
...
4. Fix the spec drift on `intro_escape_shaft_area.yaml`: either update
   ...
   to intro.ldtk with `--ldtk crates/ambition_platformer2d_actor_monolith/assets/ambition/worlds/intro.ldtk`.
5. After the shape lands, re-run the section-9 validate command and a quick
   `cargo run -p ambition_platformer2d_actor_monolith --bin headless` smoke check. Update this
