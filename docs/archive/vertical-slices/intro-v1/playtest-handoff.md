...
```text
 1. Run `cargo run -p ambition_platformer2d_actor_monolith --bin headless -- --start-room=intro_wake_room`
...
cargo run -p ambition_platformer2d_actor_monolith --bin headless -- --start-room=intro_wake_room
...
-p ambition_platformer2d_actor_monolith --lib` (584/584), headless smoke for 120 ticks.
...
### A. Chained flag system (`crates/ambition_platformer2d_actor_monolith/src/intro/route_state.rs`)
