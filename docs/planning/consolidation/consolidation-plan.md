...
<!-- alias-split: SessionWorldRef=165/92 SessionWorldMut=12/11 live_session_world_root=3/1 session_root_for_scope=2/2 -->
| spelling | what it is | production uses |
| --- | --- | ---: |
| `SessionWorldRef<T>` | `Single<Ref<T>, With<SessionRoot>>` | 165, in 92 files |
