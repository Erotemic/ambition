...
| genuinely open, all needing a seam | **2** (tether, tech result) — ⚠ was 3; hit-grab moved out 2026-09-04 when its seam turned out to be built and already carrying a production technique |
