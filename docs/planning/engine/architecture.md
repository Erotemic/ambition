...
| `ambition_projectiles` | **[the projectile kit]** | projectile vocabulary/components, spawn pools, substrate spawn executors, portal transit; victim-routing steppers stay in the sim heart until their actor/world inputs split | → kernels/effect vocabularies; sim consumes it |
