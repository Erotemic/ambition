...
- [`crates/ambition_engine/src/movement/player.rs`](../../crates/ambition_engine/src/movement/player.rs) (the `ae::Player` struct definition).
- [`crates/ambition_engine/src/player_state.rs`](../../crates/ambition_engine/src/player_state.rs) (`BodyMode`, `ResourceMeter`, `LocomotionState`, `try_change_body_mode`, `classify_player_safety`).
...
| Body mode | [`body_mode/mechanics.rs`](../../crates/ambition_sandbox/src/body_mode/mechanics.rs), [`body_mode/morph_ball.rs`](../../crates/ambition_sandbox/src/body_mode/morph_ball.rs), [`body_mode/tests.rs`](../../crates/ambition_sandbox/src/body_mode/tests.rs) |
...
Every field on [`ae::Player`](../../crates/ambition_engine/src/movement/player.rs#L26)
...
- `crates/ambition_engine/src/movement/player.rs` (the `Player` struct).
