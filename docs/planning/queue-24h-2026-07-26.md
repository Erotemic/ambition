...
- ▢ **Y′8 (their H5 half) — a fighter can still take a simulation tick before
  countdown suspension applies.** The countdown gate landed; spawning fighters
  ALREADY suspended did not. Belongs with Phase B, where construction changes.
