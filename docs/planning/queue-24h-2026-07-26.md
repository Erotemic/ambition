...
- ◐ **T2 consumer-owned art still cannot reach a CHARACTER.** The overlay reader
  ...
  agreed to.
  ▢ **and it stops there, honestly.** Proving a consumer character DRAWS from
  consumer-owned art needs a real sheet committed under
  `fixtures/external_consumer/assets`, and this repo does not commit binary or
  generated art. The addressing is fixed and unit-tested; the end-to-end render
  wants generated art and is its own row.
