...
- ▢ **D9** (Task 10) no domain enumeration exists, so "every reviewed domain has
  an explicit ruling" cannot be checked. A WRITING task, not a refactor — and it
  would give Task 9 the vocabulary it is missing.
