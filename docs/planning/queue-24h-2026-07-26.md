...
- ✔ **H1 (their #3/#4) — CLOSED 2026-07-29 by the finalization barrier.**
  ...
  → identity REPLACEMENT on the seated path is still not atomic. That is Phase B,
  and it is deliberately a separate commit: resolution and construction must not
  change together or a regression is attributable to neither.
