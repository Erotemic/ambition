...
- ✔ **X12** delete runtime arbitration — **REFRAMED, then met (2026-07-28).**
  ...
  X14's contracts do. Two more landed: `one-caller-of-the-provider-resolver` and
...
- ◐ **X14** C3.7 guard rows in `check_absence_contracts.py`, comment-stripped,
  ...
  ✔ **first row landed 2026-07-28: `one-reader-of-the-catalog-default-action-set`.**
...
- ✔ **X-audit (2026-07-28, late)** — the inventory doc and the ledger had
  ...
  resolver a second caller grows on. `one-caller-of-the-movement-tuning-resolver`
...
- ▢ **H7 (their #8) — the one-caller contracts prove CONFINEMENT, not
