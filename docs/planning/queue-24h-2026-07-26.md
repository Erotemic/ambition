...
- ✔ **L19 no STAGE seats more than two.**
  ...
  ▢ **not done:** nothing checks a 2v2 END TO END — four pads pressing four
  buttons and moving four bodies. The 1v1 has that
  (`two_controllers_make_versus_a_two_player_game`); the 2v2 asserts seating and
  the relation, not four live devices.
