...
▢ **what this does not do is explain it.** The next step is a trace of a level-9
d12 death against the d0 death of the same match — the rollout is vetoing
something, and on this stage the veto is now shortening a life rather than
saving it.
