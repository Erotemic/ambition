...
* **S15** ▢ the next one, already scoped: collapse AF4b's duplication.

**Still open and worth doing next:** S15; the instrument's last budgeted row
(`sync_cutscene_ui`); then the backlog below by the review's standard.
...
### ▢ S15. Collapse AF4b's duplication — the lineage stops authoring content facts
