...
that leaves the stage through? The shadow models a dash as `dash_speed` held for
...
px further. That is a hypothesis, not a finding, and it needs a per-decision
