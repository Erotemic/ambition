...
loaded it"*. A second test pins the other half: a theme already present must not
be re-derived every frame, because a mutable deref alone marks `GameAssets`
changed and the refresh answers that by rebuilding every layer in the world.
