...
- ▢ **THE FIGHTER HOLDS JUMP FOREVER.** `jump_held` is written at exactly two
  ...
  thumb does. Then MEASURE: shorter jumps may cost the mobility the veto was
  buying, and `ladder_probe` will say.
