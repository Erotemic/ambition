...
## ⇥ START HERE (status 2026-07-31 late) — the GPT 5.6 review has the floor

A review of `7a952a3..7fb5c9a` landed and **its findings outrank every row
below.** Its standard is worth adopting verbatim: before assigning an
...
* **display name** — ▢ **UNGUARDED, and it is the same shape.**
