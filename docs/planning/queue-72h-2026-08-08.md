...
- ▢ **D13 two rows ORPHANED between runs, carried forward from `queue-72h-2026-08-06.md`.**
  ...
  * **E1b — how many `#[ignore]`d tests are hiding a red?** ⛔ **the row said 30
    ...
    **The job is now: run those three, plus confirm G1 PICK 11's fixture course
    actually exists before trusting the two retired routes.** ⚠ needs the cargo
    target dir to itself.
