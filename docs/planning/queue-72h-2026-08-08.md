...
- `cargo test -p ambition_app --test app_it` is 318 tests / ~195s and was GREEN
  at `e10d269da`.
- The rollback schema is at **v16**. A registration change needs three things in
...
Plan: `~/.claude/plans/lively-drifting-conway.md`. Findings 1–4 landed as
`f043882cd` + `97ec5f450`; the wire baseline as `e10d269da`.
