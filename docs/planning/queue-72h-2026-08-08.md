...
| **D48** | is an enemy a CHARACTER or an ARCHETYPE? | ⛔⛔ **BLOCKED ON JON** — 41 of 65 already name a character |
...
cannot retire for bosses) · D48's character-vs-archetype fork · the
...
- ▢ **D72 ⭐⭐ THE RUN'S TOP PRIORITY, SET BY JON 2026-08-09: SMASH IS THE ENGINE
...
- The rollback schema is at **v23** (`registry.rs`), **423 baseline rows** /
