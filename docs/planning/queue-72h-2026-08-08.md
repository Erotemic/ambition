...
- ▢ **D5 the smash → ambition character leak — Jon's own words, and the only
  entry in his file carrying NO triage mark.** It sits after the final `----`
  (obs:587) and is in the queue nowhere, so a whole run could pass over it:
