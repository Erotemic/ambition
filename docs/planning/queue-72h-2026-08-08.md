...
⛔ **BLOCKED ON JON — and as of 2026-08-09 NOTHING here blocks work**: ~~which
game was the death in (D68)~~ ✔ **resolved by Jon 2026-08-09** · D48's
character-vs-archetype fork · the measurement-submodule pointer · the
...
- ▢ **D72 ⭐⭐ THE RUN'S TOP PRIORITY, SET BY JON 2026-08-09: SMASH IS THE ENGINE
  ...
  * ▢ **then the eight-item architectural roadmap**, then the feel layer. My
