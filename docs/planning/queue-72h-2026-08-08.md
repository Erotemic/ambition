...
- ▢ **D75 SEVERAL HOSTS REACH ENEMY CONSTRUCTION WITH AN EMPTY PREPARED CAST.**
  ...
  **Where to start**: `register_character` installs `CharacterPreparationPlugin`
  and publishes at the plugin-composition barrier. Find whether these hosts
  cross that barrier at all, or cross it before the experience plugins build.
