...
- ▢ **D71 ⛔⛔ ROOMS CHANGED WITH NO TRANSITION TRANSACTION — and if that is still
  true it is the whole of Jon's magenta flash.** Found 2026-08-09 by the D46
  worker, **in the profile capture, not by reading code.**
