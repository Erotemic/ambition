...
- ✔ **D44 LANDED 2026-08-08 — THE BBOX QUAD ROUTE IS IN, AND IT FIXES NONE OF
  ...
  * ⛔ **hardly anything reaches the path that changed.** Probed live:
  ...
  the body, and **2 of 190 sheets set it**. That is the next row, and the
  observations row's *"the blocker is data: 2 of 190 declare `authored_body`"* was
  right about the wrong question and right about this one.
