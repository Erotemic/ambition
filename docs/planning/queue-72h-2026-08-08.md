...
- ▢ **D58 ⭐⭐ A FINGER CANNOT TAP A SMASH PORTRAIT, BECAUSE THE SCREEN READS
  `Window::cursor_position` AND TOUCH NEVER SETS IT.** The real answer to Jon's
  *"on android, I could not use touch controls on some menus, e.g. in smash"* —
  found without hardware, 2026-08-09.
