...
- ▢ **D55 THE SHIELD BUBBLE TRACKS THE COLLISION BOX; THE CHARACTER TRACKS ITS
  FEET. NOTHING RECONCILES THEM.** Jon's *"The main character shield sprite has
  the bubble in the wrong place, just kinda to the upper left."*
  ⇒ ⭐ **probably a SYMPTOM of D47, not its own bug** — file the fix there.
