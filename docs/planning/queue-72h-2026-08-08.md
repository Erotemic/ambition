...
| row | what | state |
|---|---|---|
| **D71** | ⭐⭐ rooms changed with **no transition transaction** | 🔴 **IN FLIGHT** — an uncovered room change explains Jon's flash **completely**; may already be stale |
...
| **D69** | a promoted hidden block loses its picture | 🔴 **IN FLIGHT** — removals reconcile mid-run, **additions do not** |
...
| **D52** | live quality Apply | ✔ prop stamp · ✔ tier split ⇒ ▢ **(A) provenance is dispatchable NOW**; (B) needs a device; ⚠ neither closes 193→527 MB |
...
⛔ **BLOCKED ON JON, and only the first blocks work**: **which game was the death
in** (D68) · D48's character-vs-archetype fork · the measurement-submodule
pointer · the rust-analyzer setting.
