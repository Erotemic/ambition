...
| **D49** | the LDtk editor nulled the mount refs | ⭐⭐ **4 values, recoverable from git, not 48** · 🔴 **RESTORE IN FLIGHT** |
...
- ▢ **D45 SIXTEEN MORE OBSERVATIONS FROM JON (`7ace7b5e7`) — INDEX, not triage.**
  ...
  * **pirate sky** — the pirates no longer ride their sharks
    (⇒ ✔ **D49 SOLVED**: an LDtk editor session nulled every `EntityRef` in
    `sandbox.ldtk` on 2026-07-06; guard landed, refs deliberately unrepaired);
...
- ▢ **D49 ⭐⭐ THE LDTK EDITOR NULLED EVERY `EntityRef` IN `sandbox.ldtk`, AND
  THAT IS WHY THE PIRATES STOPPED RIDING THEIR SHARKS.** Jon's observation *"The
  pirates in the pirate sky no longer ride their sharks"* — **fully diagnosed
  2026-08-09, cause named, commit identified, blast radius measured.**

  ### ✔✔ 2026-08-09 — THE FIX IS A MECHANICAL RESTORE OF **FOUR** VALUES, NOT 48
