...
- ▢ **D45 SIXTEEN MORE OBSERVATIONS FROM JON (`7ace7b5e7`) — INDEX, not triage.**
  ...
  * **art / misc** — the shield bubble sits up-and-left of the character
    (⇒ **D55**, now REPRODUCED and measured: it is a second, ~2.5×-oversized ring
    that follows the body at a constant offset — five mechanisms dead, a probe
    dispatched); the
...
- ▢ **D62 ⭐⭐ THE COIN SOUND IS EMITTED AND THEN SILENCED BY POLICY — MARY-O NEVER
...
- ▢ **D63 ⭐ SMALL MARY-O BREAKS BRICKS BECAUSE `break_bricks` NEVER ASKS WHAT FORM
