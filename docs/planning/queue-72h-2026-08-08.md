...
- ▢ **D110 ⛔ HITLAG IS PRIMARY-PLAYER-SCOPED — a hit between two fighters that
  ...
  **Nothing on the actor road reads it.** Every reader is one of four:
  ...
  ⇒ **so D110 is not the bug it reads as.** *"Give the actor road a hitlag
...
- ▢ **D109 JON'S "MARY-O CAN ONLY HAVE 1 FIREBALL OUT" IS SATISFIED IN CODE AND
...
- ✔ **D112 CLOSED 2026-08-14 — THE DEATH ROAD WAS NEVER BROKEN; THE FIXTURE
  ...
  mirror deletion, D110's hitlag scoping). ⛔ **a measurement taken at the wrong
