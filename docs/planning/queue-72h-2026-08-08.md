...
- ◐ **D95 THIRTY-TWO PLACEMENTS HAVE THE RIGHT RESPAWN POLICY BY COINCIDENCE**
  ...
  seven.
  ⇥ ▢ the rest, sized: `puppy_slug` (10), `burning_flying_shark` (7),
  `sanic_badnik` (4), `sky_parrot` (2), `ai_slop` (1). Same edit, same reason;
  each one removes the last reader of a dead brain key, which is what
  `combatant`'s own deletion (P2.18/P2.22) waits on.
