...
- ▢ **D83 ⭐ THE `player_robot` ARCHETYPE ROW IS HALF-MIGRATED — 80 LINES, AND
  WHAT IS LEFT IS ONE ACTION SET.** The biggest single row in
  ...
  **Migrated 2026-08-11:** the body onto the robot LINEAGE (shared by v0/v2/v3 —
  ...
  ⇥ **WHAT IS LEFT, and it is one thing:** the row's ACTION SET has no home yet —
