...
| **P1** | **SESSION CONSTRUCTION SHOULD CONSUME THE GENERATION IT ACTIVATED**, not the globally-visible registry that a schedule edge happens to have updated first. The edge is real and pinned; generation binding is stronger and is not done. |
