...
- 2026-09-24 (AP15): falling-sand's temporary Swim writes `BodyAbilities.swim`
  directly with an unfiltered query, beside `project_editable_abilities`
  rewriting `BodyAbilities = AbilityBase ∩ mask` every tick for the primary
  player. Two writers of the effective set; see the AP15 residuals.
