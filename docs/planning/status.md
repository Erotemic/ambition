...
| feature-gated tests | **810 hidden behind features across 29 crates** (2026-09-04 late; the figure moved 793 → 798 → 800 → 803 in one day, so RUN the tool rather than quoting this) | `scripts/feature_gated_tests.py` |
