...
1. **JS AudioContext-unlock shim** in `crates/ambition_gameplay_core/web/index.html`.
...
`crates/ambition_gameplay_core/assets/` to `crates/ambition_gameplay_core/web/assets/`
