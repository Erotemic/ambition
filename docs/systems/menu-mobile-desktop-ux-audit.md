...
- `crates/ambition_sandbox/src/ui_nav/` contains shared list, pointer, and drag helpers.
- `crates/ambition_sandbox/src/menu/ir/` and `crates/ambition_sandbox/src/menu/map/` own sandbox menu data and map-tab behavior.
