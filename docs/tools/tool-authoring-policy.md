...
Generated outputs are local by default. A tool must provide an explicit install/publish step before outputs should enter `crates/ambition_sandbox/assets/` or another runtime path.
