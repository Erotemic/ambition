...
/// lives on [`WorldSourceHotReload`] — mirroring the pause-menu Developer page,
...
pub(crate) struct DevToggleRead<'a> {
    ...
    pub(crate) ldtk_reload: &'a ambition_platformer2d::dev_tools::WorldSourceHotReload,
    ...
    pub(crate) portal_effect: Option<&'a ambition_platformer2d::portal_presentation::PortalEffectSelection>,
...
pub(crate) struct DevToggleWrite<'a> {
    ...
    pub(crate) ldtk_reload: &'a mut ambition_platformer2d::dev_tools::WorldSourceHotReload,
...
pub(crate) fn dev_snapshot(ctx: DevToggleRead<'_>) -> DevSnapshot {
    ...
    // LDtk hot-reload (WorldSourceHotReload) — the resource-backed LDtk row.
    values.push(DevSnapshot::toggle(
        D::LdtkAutoApply,
...
pub(crate) fn apply_dev_toggle(ctx: DevToggleWrite<'_>, id: DevToggleId, dir: i32) {
    ...
    match id {
        ...
        // LDtk auto-reload on `WorldSourceHotReload` (mirrors the pause
