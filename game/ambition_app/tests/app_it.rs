...
mod director_teleport_blink;
mod the_director_leaves_a_note;
...
mod first_room_art;
mod frozen_belief_does_not_resurrect;
mod the_home_body_holds_the_mana_it_declared;
...
mod portal_compositing_is_wired_in_the_shipped_app;
...
mod the_trace_records_one_clock_per_tick;
...
mod morph_ball_is_the_protagonists;
