...
//! ([`ambition_platformer2d_actor_monolith::features::banter::CombatBanterRegistry`]) so
...
pub use ambition_platformer2d_actor_monolith::features::banter::CombatBanterRegistry;
