...
pub fn bob_moveset() -> MovesetContract {
    ...
    let verbs = [
        ("attack", "tap_test"),
        ("attack_forward", "wrench_swing"),
        ("attack_up", "pressure_release"),
        ("attack_down", "shim"),
        ("smash_forward", "rivet_smash"),
        ("smash_up", "derrick_lift"),
        ("smash_down", "ground_anchor"),
        ("attack_air", "loose_bearing"),
        ("attack_air_forward", "swing_arm"),
        ("attack_air_back", "counterweight"),
        ("attack_air_up", "jack_stand"),
        ("attack_air_down", "pile_driver"),
        ("special", "rivet_gun"),
        ("special_forward", "piston_charge"),
        ("special_up", "steam_lift"),
        ("special_down", "bulkhead_drop"),
        ("special_air_down", "bulkhead_dive"),
    ]
    .into_iter()
