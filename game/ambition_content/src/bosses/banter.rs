...
pub fn tick_boss_idle_barks(
    ...
    for (feature, health, combat) in &ecs_bosses {
        ...
        if !matches!(
            ...
            ambition_platformer2d_actor_monolith::boss_encounter::BossEncounterPhase::Phase1
                | ambition_platformer2d_actor_monolith::boss_encounter::BossEncounterPhase::Phase2
                | ambition_platformer2d_actor_monolith::boss_encounter::BossEncounterPhase::Enrage
        ) {
            continue;
        }
