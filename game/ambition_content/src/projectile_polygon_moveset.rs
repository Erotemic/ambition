...
pub fn projectile_polygon_moveset() -> MovesetContract {
    ...
    let side_special = impulse(
        committed_tail(
            strike(
                "polygon_projectile_vector_rush", "attack_side", 0.11, 0.11, 0.23,
    ...
    let mut uppercut = strike(
        "polygon_projectile_recoil_lift", "attack_up", 0.08, 0.12, 0.19,
    ...
    let grounded_down_special = committed_tail(
        strike(
            "polygon_projectile_low_burst", "attack_down", 0.13, 0.10, 0.25,
    ...
    let mut airborne_down_special = strike(
        "polygon_projectile_downward_vector", "air_down", 0.10, 0.11, 0.22,
...
mod tests {
    ...
    fn the_reference_projectile_fighter_answers_the_complete_typed_repertoire() {
        ...
        for id in [
            "polygon_projectile_jab", "polygon_projectile_tilt_forward", "polygon_projectile_tilt_up",
            "polygon_projectile_tilt_down", "polygon_projectile_smash_forward", "polygon_projectile_smash_up",
            "polygon_projectile_smash_down", "polygon_projectile_air_neutral", "polygon_projectile_air_forward",
            "polygon_projectile_air_back", "polygon_projectile_air_up", "polygon_projectile_air_down",
            "polygon_projectile_shot", "polygon_projectile_vector_rush", "polygon_projectile_recoil_lift",
            "polygon_projectile_low_burst", "polygon_projectile_downward_vector", "polygon_projectile_grab",
            "polygon_projectile_pummel", "polygon_projectile_throw_forward", "polygon_projectile_throw_back",
            "polygon_projectile_throw_up", "polygon_projectile_throw_down",
            "projectile_polygon_taunt", "projectile_polygon_dash_attack",
        ] {
