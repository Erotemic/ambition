...
// robot rows are stand-ins for the lineage the content catalog owns; see
// `select::STAND_INS`. The rows are in `assets/data/character_catalog.ron`.
