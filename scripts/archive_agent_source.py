...
def build_archive(repo_arg: Path, output_arg: Path | None, prefix_arg: str | None, keep_stage: bool, verbose: int, allow_forbidden: bool = False) -> Path:
    log = Log(verbose)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        build_archive(args.repo, args.output, args.prefix, args.keep_stage, verbose=0 if args.quiet else 1, allow_forbidden=args.allow_forbidden)
    finally:
