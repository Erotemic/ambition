...
INTRO_LAB_PNG = (
    REPO_ROOT / "crates/ambition_platformer2d_actor_monolith/assets/sprites/intro_lab_tileset.png"
)
TOWN_PNG = REPO_ROOT / "crates/ambition_platformer2d_actor_monolith/assets/sprites/town_tileset.png"
