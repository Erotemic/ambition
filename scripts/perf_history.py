...
def cmd_report(args) -> int:
    rows = sorted(load(args.ledger), key=order_key)
    # ⛔ REPO-RELATIVE, BECAUSE THE OUTPUT IS COMMITTED. `history.LEDGER` is an
    # absolute path built from this checkout's location, so writing it verbatim
    # put one machine's home directory into a tracked document — the committed
    ...
    lines = [
        ...
        f"`{shown}`. ⛔ Do not hand-edit; append with",
