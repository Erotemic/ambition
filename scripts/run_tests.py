...
def build_jobs(only: list[str], heavy: bool, libtest_args: list[str],
    ...
    if only:
        ...
        # invisible to this job, and the scanner counts 448 feature-gated tests
    ...
    *,
    ...
    if not exhaustive:
        ...
        notices.append(
            ...
            "        2026-09-26 by `scripts/feature_gated_tests.py`, 448 tests\n"
            ...
            "        IS unified into `--workspace`, so some of the 448 do run\n"
