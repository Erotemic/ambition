...
def validate(
    ...
    # See `crates/ambition_platformer2d_actor_monolith/src/ldtk_world/loading.rs::merge_secondary_worlds`
    ...
    for source_level, area, zone_id, target_room, target_zone in requested_links:
        ...
        if target["activation"] == "EdgeExit":
            ...
            # crates/ambition_platformer2d_actor_monolith/src/world/rooms/spawn.rs so
