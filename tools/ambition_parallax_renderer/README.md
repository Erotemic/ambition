...
`crates/ambition_platformer2d_actor_monolith/assets/backgrounds/parallax_layers/`.
...
python -m ambition_parallax_renderer draw-backgrounds \
  --out-dir ../../crates/ambition_platformer2d_actor_monolith/assets/backgrounds/parallax_layers
```
