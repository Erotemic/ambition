...
def doc_to_python(doc: RigDocument) -> str:
    ...
    a("")
    a("from ambition_sprite2d_renderer.rig import clamp, lerp, smoothstep  # noqa: F401 - for lambdas")
    a("from ambition_sprite2d_renderer.rigdoc import paint_part")
    a("from ambition_sprite2d_renderer.skeleton import Channel, Clip, Skeleton, two_bone_ik")
    a("from ambition_sprite2d_renderer.tackon_sheet import build_sheet, write_canonical")
    a("")
