...
def _draw_glow(base: Image.Image, points: list[Point], color: RGBA, blur: float = 4.0) -> None:
...
def _draw_flame_plume(base: Image.Image, anchor: Point, direction: Point, scale: float, phase: float) -> None:
    ax, ay = anchor
    dx, dy = direction
    ...
    outer = [
        ...
        (ax + nx * width * 0.42 + dx * length * 0.75, ay + ny * width * 0.42 + dy * length * 0.75),
        (ax + dx * length, ay + dy * length),
        (ax - nx * width * 0.35 + dx * length * 0.72, ay - ny * width * 0.35 + dy * length * 0.72),
    ...
    mid = [
        ...
        (ax + nx * width * 0.18 + dx * length * 0.65, ay + ny * width * 0.18 + dy * length * 0.65),
        (ax + dx * length * 0.84, ay + dy * length * 0.84),
        (ax - nx * width * 0.16 + dx * length * 0.60, ay - ny * width * 0.16 + dy * length * 0.60),
    ]
    inner = [
        ...
        (ax + dx * length * 0.30 - nx * width * 0.08, ay + dy * length * 0.30 - ny * width * 0.08),
    ]
