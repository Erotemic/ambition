...
class SideGoblinGenerator:
    ...
    PALETTES = {
        ...
        "cave": {
            "skin": rgba("#5F6F68"),
            "skin_top": rgba("#8EA29A"),
            "skin_shadow": rgba("#35423E"),
            "belly": rgba("#778A82"),
            "cloth": rgba("#394BA0"),
            "cloth_dark": rgba("#242C69"),
            "eye": rgba("#6BE9FF"),
            "eye_glow": rgba("#D9FFFF"),
            "outline": rgba("#15171B"),
            "mouth": rgba("#251D1D"),
            "tooth": rgba("#F4EBD5"),
            "weapon": rgba("#75B8FF"),
            "weapon_dark": rgba("#2D5E98"),
            "metal": rgba("#CDD3DA"),
            "shadow": rgba("#000000", 36),
        },
        "desert": {
            "skin": rgba("#A7A34B"),
            "skin_top": rgba("#D4C76B"),
            "skin_shadow": rgba("#67632B"),
            "belly": rgba("#BDB65D"),
            "cloth": rgba("#B06B2A"),
            "cloth_dark": rgba("#72451D"),
            "eye": rgba("#FF7059"),
            "eye_glow": rgba("#FFD0C7"),
            "outline": rgba("#15171B"),
            "mouth": rgba("#2A1B18"),
            "tooth": rgba("#F4EBD5"),
            "weapon": rgba("#FFB15E"),
            "weapon_dark": rgba("#9A5A25"),
            "metal": rgba("#E7DDC4"),
            "shadow": rgba("#000000", 34),
        },
        "frost": {
            "skin": rgba("#6EA0A3"),
            "skin_top": rgba("#A8DDE0"),
            "skin_shadow": rgba("#3B686B"),
            "belly": rgba("#85BFC0"),
            "cloth": rgba("#5063B8"),
            "cloth_dark": rgba("#2B3677"),
            "eye": rgba("#FFFFFF"),
            "eye_glow": rgba("#B6FFF5"),
            "outline": rgba("#15171B"),
            "mouth": rgba("#1E2527"),
            "tooth": rgba("#F4EBD5"),
            "weapon": rgba("#9FEAFF"),
            "weapon_dark": rgba("#37798C"),
            "metal": rgba("#E2F6FA"),
            "shadow": rgba("#000000", 34),
        },
        "brute": {
            "skin": rgba("#7B8F35"),
            "skin_top": rgba("#A8C24D"),
            "skin_shadow": rgba("#4D5C23"),
            "belly": rgba("#8DA544"),
            "cloth": rgba("#8A3A2B"),
            "cloth_dark": rgba("#5C241B"),
            "eye": rgba("#FF7059"),
            "eye_glow": rgba("#FFD0C7"),
            "outline": rgba("#15171B"),
            "mouth": rgba("#2A1B18"),
            "tooth": rgba("#F4EBD5"),
            "weapon": rgba("#FF8A5E"),
            "weapon_dark": rgba("#A0432D"),
            "metal": rgba("#E2D3C0"),
            "shadow": rgba("#000000", 38),
        },
        "shaman": {
            "skin": rgba("#4C8A5B"),
            "skin_top": rgba("#78C987"),
            "skin_shadow": rgba("#2E5D37"),
            "belly": rgba("#6BAB73"),
            "cloth": rgba("#7E4FCC"),
            "cloth_dark": rgba("#4C2C87"),
            "eye": rgba("#FFE36E"),
            "eye_glow": rgba("#FFF6B0"),
            "outline": rgba("#15171B"),
            "mouth": rgba("#261D22"),
            "tooth": rgba("#F4EBD5"),
            "weapon": rgba("#B98CFF"),
        ...
        "chieftain": {
            "skin": rgba("#6E9238"),
            "skin_top": rgba("#B4CF55"),
            "skin_shadow": rgba("#3F5C25"),
            "belly": rgba("#93AA47"),
            "cloth": rgba("#C07039"),
            "cloth_dark": rgba("#6B2F1F"),
            "eye": rgba("#FFDA66"),
            "eye_glow": rgba("#FFF0A8"),
            "outline": rgba("#15171B"),
            "mouth": rgba("#291815"),
            "tooth": rgba("#F4EBD5"),
            "weapon": rgba("#FFB15E"),
            "weapon_dark": rgba("#934A25"),
            "metal": rgba("#E7D2A8"),
            "shadow": rgba("#000000", 38),
        },
        "bard": {
            "skin": rgba("#5B9A56"),
            "skin_top": rgba("#8FD36F"),
            "skin_shadow": rgba("#376333"),
            "belly": rgba("#78B763"),
            "cloth": rgba("#D85EA5"),
            "cloth_dark": rgba("#842E69"),
            "eye": rgba("#FFE36E"),
            "eye_glow": rgba("#FFF6B0"),
            "outline": rgba("#15171B"),
            "mouth": rgba("#261D22"),
    ...
    def sample_spec(
        self, seed: int, archetype: str = "default", held_item: Optional[str] = None
    ) -> GoblinSpec:
    ...
    def _draw_body(
        ...
        draw_rotated_ellipse(
            img,
            (center[0] + 2 * S, center[1] + 2 * S),
            (spec.body_w * 0.58 * S, spec.body_h * 0.60 * S),
            angle,
            pal["belly"],
            None,
            0,
    ...
    def _draw_rigid_head(
        ...
        snout_outer = _bbox(
            snout_center, spec.snout_len * 1.65 * S + ow, spec.head_h * 0.38 * S + ow
        )
        snout_inner = _bbox(
            snout_center, spec.snout_len * 1.65 * S, spec.head_h * 0.38 * S
        )
        ...
        hd.ellipse(
            (cx - 8 * S, cy - 10 * S, cx + 12 * S, cy + 1 * S),
            fill=with_alpha(pal["skin_top"], 125),
        )
        ...
        if dead:
            ...
            d.ellipse(
                (
                    eye_center[0] - spec.eye_w * S / 2,
                    eye_center[1] - eye_h / 2,
                    eye_center[0] + spec.eye_w * S / 2,
                    eye_center[1] + eye_h / 2,
                ),
                fill=pal["eye"],
        ...
        d.polygon(
            [
                (mouth_a[0] + 1 * S, mouth_a[1]),
                (mouth_a[0] + 2.7 * S, mouth_a[1]),
                (mouth_a[0] + 1.9 * S, mouth_a[1] + spec.tooth_size * S),
            ],
            fill=pal["tooth"],
            outline=outline,
        )
    ...
    def _limb_chain(
        self, root: Point, upper: float, lower: float, a1: float, a2: float
    ) -> Tuple[Point, Point]:
    ...
    def _draw_weapon(
        ...
        if item == "spear":
            ...
            d.polygon(
                [tip, add(tip, (-5 * S, -3 * S)), add(tip, (-4 * S, 3 * S))],
                fill=pal["metal"],
                outline=pal["outline"],
            )
        elif item == "sword":
            ...
            d.rounded_rectangle(
                (head[0] - 5 * S, head[1] - 5 * S, head[0] + 8 * S, head[1] + 5 * S),
                radius=2 * S,
                fill=pal["metal"],
                outline=pal["outline"],
            ...
            d.ellipse(
                (tip[0] - 5 * S, tip[1] - 5 * S, tip[0] + 5 * S, tip[1] + 5 * S),
                fill=pal["eye"],
                outline=pal["outline"],
            ...
            tip = add(handle, vec(16 * S, angle - 4))
            d.arc(
                (tip[0] - 4 * S, tip[1] - 17 * S, tip[0] + 14 * S, tip[1] + 17 * S),
                start=250,
                end=105,
                fill=pal["weapon"],
            ...
            d.line(
                [(tip[0] + 6 * S, tip[1] - 12 * S), (tip[0] + 6 * S, tip[1] + 12 * S)],
                fill=pal["metal"],
                width=max(1, int(0.8 * S)),
            )
            d.line(
                [handle, (tip[0] + 19 * S, tip[1])],
                fill=pal["metal"],
    ...
    def _draw_blink_out_fx(
        ...
        for rscale, alpha in [
            ...
            d.ellipse(
                box, outline=with_alpha(pal["eye"], alpha), width=max(1, int(1.3 * S))
            )
        ...
        for i, dx in enumerate((-10, -4, 3, 10)):
            ...
            if alpha > 0:
                ...
                d.line(
                    ...
                    fill=with_alpha(pal["cloth"], alpha),
                    width=max(1, int(1.6 * S)),
                )
                d.line(
                    [(x + 3 * S, mid_y - height / 2), (x - 4 * S, mid_y + height / 2)],
                    fill=with_alpha(pal["eye"], max(18, alpha - 20)),
                    width=max(1, int(0.9 * S)),
                )
        ...
        for i in range(4):
            ...
            d.line(
                [(sx, sy), (ex, ey)],
                fill=with_alpha(pal["eye"], int(62 * max(charge, burst))),
                width=max(1, int(1.0 * S)),
            )
        ...
        if ripple_alpha > 0:
            d.ellipse(
                ...
                outline=with_alpha(pal["cloth"], ripple_alpha),
                width=max(1, int(1.0 * S)),
            )
    ...
    def _draw_blink_in_fx(
        ...
        for i, dx in enumerate((-14, -7, 0, 8, 14)):
            ...
            d.line(
                ...
                fill=with_alpha(pal["eye"], max(16, alpha - 18)),
                width=max(1, int(0.9 * S)),
            )

        ripple_alpha = int(76 * max(0.18, 1.0 - t * 0.35))
        d.ellipse(
            (dest_x - 18 * S, ground_y - 7 * S, dest_x + 15 * S, ground_y + 1 * S),
            outline=with_alpha(pal["eye"], ripple_alpha),
            width=max(1, int(1.0 * S)),
        )
    ...
    def _composite_teleport_actor(
        ...
        if animation == "blink_out":
            ...
            for i, x in enumerate(range(x1, x2, slice_w)):
                ...
                dx = (frac - 0.5) * (21.0 * S * progress) + math.sin(
                    frac * math.pi * 7.0 + progress * 6.0
                ) * 1.6 * S * progress
    ...
    def _draw_variant_accessories(
        ...
        if any(token in name for token in ["chieftain", "chief"]):
            ...
            for dx in (-12, 0, 12):
                d.polygon(
                    [
                        (head_center[0] + dx * S - 7 * S, head_center[1] - 27 * S),
                        (head_center[0] + dx * S, head_center[1] - 42 * S),
                        (head_center[0] + dx * S + 7 * S, head_center[1] - 27 * S),
                    ],
                    fill=pal["weapon"],
                    outline=outline,
            ...
            d.line(
                [
                    (body_center[0] - 24 * S, body_center[1] + 15 * S),
                    (body_center[0] - 24 * S, body_center[1] - 26 * S),
                ],
                fill=outline,
                width=max(1, int(2 * S)),
            )
            d.polygon(
                [
                    (body_center[0] - 24 * S, body_center[1] - 26 * S),
                    (body_center[0] - 5 * S, body_center[1] - 19 * S),
                    (body_center[0] - 24 * S, body_center[1] - 12 * S),
                ],
                fill=pal["cloth"],
                outline=outline,
            )
            ...
            for dx in (-22, 24):
                d.line(
                    [
                        (head_center[0] + dx * S, head_center[1] - 13 * S),
                        (head_center[0] + dx * S, head_center[1] + 5 * S),
                    ],
                    fill=pal["cloth"],
                    width=max(1, int(2 * S)),
                )
            ...
            d.line(
                [
                    (body_center[0] - 22 * S, body_center[1] + 10 * S),
                    (body_center[0] - 8 * S, body_center[1] + 9 * S),
                ],
                fill=pal["weapon"],
                width=max(1, int(1 * S)),
            )
            ...
            for dx in (-8, 2, 12):
                d.polygon(
                    [
                        ...
                        (head_center[0] + (dx + 5) * S, head_center[1] - 40 * S),
                        (head_center[0] + (dx + 10) * S, head_center[1] - 28 * S),
                    ],
                    fill=pal["tooth"],
                    outline=outline,
                )
            ...
            for dx, dy in [(-18, -34), (3, -39), (23, -31)]:
                d.ellipse(
                    (
                        head_center[0] + dx * S - 2 * S,
                        head_center[1] + dy * S - 2 * S,
                        head_center[0] + dx * S + 2 * S,
                        head_center[1] + dy * S + 2 * S,
                    ),
                    fill=pal["eye_glow"],
            ...
            d.polygon(
                [
                    (head_center[0] - 24 * S, head_center[1] - 12 * S),
                    (head_center[0] + 11 * S, head_center[1] - 25 * S),
                    (head_center[0] + 26 * S, head_center[1] - 8 * S),
                    (head_center[0] + 6 * S, head_center[1] - 13 * S),
                ],
                fill=pal["cloth"],
                outline=outline,
            )
            d.line(
                [
                    (body_center[0] - 16 * S, body_center[1] - 3 * S),
                    (body_center[0] + 18 * S, body_center[1] + 13 * S),
                ],
                fill=pal["cloth_dark"],
                width=max(1, int(2 * S)),
            )
            ...
            for dx in (-10, 6, 20):
                d.line(
                    [
                        (head_center[0] + dx * S, head_center[1] + 20 * S),
                        (head_center[0] + (dx - 4) * S, head_center[1] + 29 * S),
                    ],
                    fill=pal["cloth"],
                    width=max(1, int(2 * S)),
                )
            ...
            d.polygon(
                [
                    (head_center[0] + 17 * S, head_center[1] - 18 * S),
                    (head_center[0] + 33 * S, head_center[1] - 23 * S),
                    (head_center[0] + 24 * S, head_center[1] - 11 * S),
                ],
                fill=pal["cloth"],
                outline=outline,
            )
    ...
    def _render_highres(
        ...
        d.ellipse(
            (
                root_x - 26 * S,
                ground_y - 5 * S,
                root_x + (31 + 13 * p.collapse) * S,
                ground_y + 6 * S,
            ),
            fill=(0, 0, 0, int(30 * (1 - 0.28 * p.collapse))),
        )

        if animation == "blink_out":
            self._draw_blink_out_fx(
                img, root_x, ground_y, S, frame_index, frame_count, pal
            )
        elif animation == "blink_in":
            self._draw_blink_in_fx(
                img, root_x, ground_y, S, frame_index, frame_count, pal
            )
        ...
        body_center = (
            ...
            ground_y - lerp(37 * S, 11 * S, collapse) + p.body_bob * S,
        )
        head_center = (
            root_x + lerp(16 * S, 37 * S, collapse),
            ground_y - lerp(62 * S, 15 * S, collapse) + p.body_bob * 0.45 * S,
        )
        ...
        for hip, a1, a2, tint, foot_shift in [
            ...
            knee, ankle = self._limb_chain(
                hip, spec.leg_upper * S, spec.leg_lower * S, a1, a2
            )
            draw_capsule(
                character_draw, hip, knee, 2.5 * S, tint, pal["outline"], 1.2 * S
            )
            draw_capsule(
                character_draw, knee, ankle, 2.3 * S, tint, pal["outline"], 1.2 * S
            )
            foot_center = (
                ankle[0] + spec.foot_w * 0.32 * S + foot_shift * S,
        ...
        self._draw_variant_accessories(
            character_draw, spec, pal, S, root_x, ground_y, body_center, head_center
        )
        ...
        draw_capsule(
            character_draw, elbow, hand, 2.2 * S, pal["skin"], pal["outline"], 1.1 * S
        )
        character_draw.ellipse(
            (
                hand[0] - spec.hand_r * S,
                hand[1] - spec.hand_r * S,
                hand[0] + spec.hand_r * S,
                hand[1] + spec.hand_r * S,
            ),
            fill=pal["skin"],
        ...
        if p.slash_arc > 0.18:
            character_draw.arc(
                (hand[0] - 6 * S, hand[1] - 30 * S, hand[0] + 38 * S, hand[1] + 19 * S),
                start=-70,
                end=45,
                fill=(242, 77, 255, 155),
