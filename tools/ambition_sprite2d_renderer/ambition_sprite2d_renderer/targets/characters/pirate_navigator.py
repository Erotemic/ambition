...
ACTOR_METADATA = {'actor': {'character_id': 'npc_pirate_navigator', 'display_name': 'Pirate Navigator'},
 'body': {'body_plan': 'HumanoidBiped',
          'body_kind': 'Standard',
          'mass_class': 'Medium',
          'traits': ['story', 'humanoid', 'enemy', 'combatant', 'ranged', 'pirate', 'navigator'],
 ...
 'tags': ['story', 'humanoid', 'enemy', 'combatant', 'ranged', 'pirate', 'navigator'],
 'sockets': {'head': {'source': 'explicit.profile.humanoid', 'point': {'x': 64.0, 'y': 24.0}},
             ...
             'muzzle': {'source': 'explicit.profile.ranged_humanoid',
                        'point': {'x': 96.0, 'y': 58.0}},
             'projectile_origin': {'source': 'explicit.profile.ranged_humanoid',
                                   'point': {'x': 96.0, 'y': 58.0}},
             'compass': {'source': 'explicit.profile.pirate', 'point': {'x': 52.0, 'y': 58.0}}},
                        ...
                        'action.melee.primary': {'animation': 'slash',
                                                 'events': [{'t': 0.34,
                                                            ...
                                                            {'t': 0.58,
                                                             ...
                                                             'source': 'explicit.profile.combat_humanoid'}]},
                        'action.ranged.primary': {'animation': 'slash',
                                                  'events': [{'t': 0.5,
