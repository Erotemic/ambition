...
ACTOR_METADATA = {'actor': {'character_id': 'npc_pirate_quartermaster', 'display_name': 'Pirate Quartermaster'},
 ...
 'tags': ['story', 'humanoid', 'enemy', 'combatant', 'pirate', 'quartermaster', 'merchant'],
