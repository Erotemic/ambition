...
def _render_frame(anim: str, frame_idx: int, nframes: int) -> Image.Image:
    ...
    if anim == "thrust":
        ...
        _poly(draw, [(guard[0] - 2, guard[1] - 4), (guard[0] + 8, guard[1] - 2), (guard[0] + 8, guard[1] + 4), (guard[0] - 2, guard[1] + 2)], GOLD, OUTLINE, 0.4)
        if pose.rapier > 0.2:
            cx, cy = blade_tip
        ...
        _poly(draw, [(gun_base[0] - 3, gun_base[1] - 3), (gun_base[0] + 10, gun_base[1] - 4), (gun_base[0] + 14, gun_base[1] + 2), (gun_base[0] + 2, gun_base[1] + 4)], WOOD, OUTLINE, 0.4)
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Render the portrait-inspired Colonial Statesman sprite sheet.")
