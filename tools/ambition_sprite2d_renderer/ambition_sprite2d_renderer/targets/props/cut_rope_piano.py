...
ACTOR_METADATA = {
    ...
    "sockets": {
        ...
        "impact": {"source": f"{TARGET_NAME}.geometry", "point": {"x": 64.0, "y": 90.0}},
    },
...
def _draw_frame(anim: str, frame_idx: int, nframes: int) -> Image.Image:
    ...
    draw.rectangle(_box(59, 2 + y, 69, 18 + y), fill=BRASS, outline=OUTLINE, width=_s(1.0))
    ...
    draw.rounded_rectangle(_box(25, 26 + y, 103, 88 + y), radius=_s(5.0), fill=WOOD_DARK, outline=OUTLINE, width=_s(2.0))
    draw.rounded_rectangle(_box(31, 31 + y, 97, 51 + y), radius=_s(3.0), fill=WOOD_MID, outline=OUTLINE, width=_s(1.2))
    draw.rectangle(_box(33, 53 + y, 95, 70 + y), fill=WOOD_LIGHT, outline=OUTLINE, width=_s(1.2))
    ...
    draw.arc(_box(41, 32 + y, 87, 51 + y), start=190, end=350, fill=HIGHLIGHT, width=_s(1.2))
    draw.rectangle(_box(36, 72 + y, 92, 82 + y), fill=WOOD_MID, outline=OUTLINE, width=_s(1.0))
    draw.line(_poly([(40, 77 + y), (88, 77 + y)]), fill=WOOD_LIGHT, width=_s(1.2))

    # Little feet / casters.
    draw.rectangle(_box(32, 86 + y, 42, 92 + y), fill=WOOD_DARK, outline=OUTLINE, width=_s(1.0))
    draw.rectangle(_box(86, 86 + y, 96, 92 + y), fill=WOOD_DARK, outline=OUTLINE, width=_s(1.0))
    ...
    draw.line(_poly([(97, 35 + y), (101, 41 + y), (97, 46 + y)]), fill=HIGHLIGHT, width=_s(1.1))
