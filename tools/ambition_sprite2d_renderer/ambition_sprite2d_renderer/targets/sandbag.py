...
idle, hit, and death. Runtime support for sparse animation rows is provided
in ``crates/ambition_sandbox/src/character_sprites.rs``; missing requests such
as walk/run/slash resolve to idle for this sheet instead of requiring alias
rows.
