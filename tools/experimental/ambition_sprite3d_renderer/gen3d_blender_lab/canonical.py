...
def _stamp_version(img: Image.Image, text: str | None = None) -> None:
    ...
    y1 = y0 + th + pad_y * 2
    try:
        draw.rounded_rectangle((x0, y0, x1, y1), radius=8, fill=(250, 252, 255, 220), outline=(70, 76, 88, 220), width=1)
    except AttributeError:
        draw.rectangle((x0, y0, x1, y1), fill=(250, 252, 255, 220), outline=(70, 76, 88, 220), width=1)
