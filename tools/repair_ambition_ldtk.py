...
# Import sibling validator helpers without requiring package installation.
TOOLS_DIR = Path(__file__).resolve().parent
sys.path.insert(0, str(TOOLS_DIR))

from validate_ambition_ldtk import normalize_project_for_editor, validate  # noqa: E402
